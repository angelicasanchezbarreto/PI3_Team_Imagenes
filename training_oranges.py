...
#Entrenamiento
training_data = 'images/images_oranges/train'
#Validacion
validation_data = 'images/images_oranges/test'
...
convolutional_neural_netwoks.save('models/model_oranges/model_oranges.h5')
convolutional_neural_netwoks.save_weights('models/model_oranges/weights_oranges.h5')
